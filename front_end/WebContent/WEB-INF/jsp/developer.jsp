...
<title>NASA PDS Archive Data Base Demo: Developer</title>
</head>
<!-- ----------------------------------------------------------------- -->
...
<li class="current"><a href="developer.jsp"><span class="left-button"><span class="right-button"><span class="itext">Developer Info</span></span></span></a></li>
...
<!-- crumbs -->
<div class="crumbs"><a href="${ctx}/pds/home">Home &gt;&gt;</a> Developer Info</div><!-- end crumbs -->
...
<div class="texts">
This web site provides a quick look into the contents of the data base that can be accessed 
via the API developed through the NASA Tournament Lab.  The API code, documentation, and 
some quick and dirty demos are available below:
<br />
<br />
<ul>
 <li><a href="http://borrelly.astro.umd.edu/web_service_javascript/js-api/">Code Directory</a></li>
 <li><a href="http://borrelly.astro.umd.edu/web_service_javascript/doc/">Documentation Directory</a></li>
 <li><a href="http://borrelly.astro.umd.edu/web_service_javascript/demos/">Demos</a>: Note that
 	the demos will only work with a recent-version Firefox browser.</li>
</div>
