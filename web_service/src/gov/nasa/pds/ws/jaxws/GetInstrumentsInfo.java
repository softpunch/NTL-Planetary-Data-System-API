...
@XmlRootElement(name = "getInstrumentsInfo", namespace = "http://pds.nasa.gov/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getInstrumentsInfo", namespace = "http://pds.nasa.gov/", propOrder = {"page", "restriction"})
